            ...
            <div className="flex flex-col gap-4 flex-1">
                {categories.map((category, idx) => (
                    <div
                        ...
                        className="group relative bg-[#0a0e27] border border-white/5 rounded-xl p-6 cursor-pointer overflow-hidden transition-all duration-300 hover:border-violet-500/50 hover:shadow-[0_0_30px_-10px_rgba(139,92,246,0.3)] flex-1 flex items-center gap-6"
                    ...
                    >
                        ...
                        {/* Icon Box */}
                        <div className="w-12 h-12 rounded-lg bg-white/5 flex items-center justify-center group-hover:scale-110 transition-transform duration-300 border border-white/5 group-hover:border-white/10">
                            {category.icon}
                        </div>
                        ...
                        {/* Arrow */}
                        <div className="w-8 h-8 flex items-center justify-center text-gray-500 group-hover:text-white group-hover:translate-x-1 transition-all">
